...
//allows selection and promotion of eligible users to reviewer status

public class ReviewerPromote {
	private final JFrame myFrame;
	private List<User> myUsers;
	private User myCaller;
	
	public ReviewerPromote(final List<User> theUsers, final User theCaller) {
		myFrame = new JFrame();
		myUsers = theUsers;
		myCaller = theCaller;
		setup();
	...
	private void setup() {
		...
		myFrame.setTitle("Promote Reviewer");
